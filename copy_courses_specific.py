...
def copy_courses(driver):
    with open("copy_courses_specific.txt", mode="r", encoding="utf-8") as copy_list:
        ...
        for copy in copy_line:
            ...
            driver.execute_script("document.getElementById('discussionBoard_id').checked = true;document.getElementById('excludeStarterPostsFalseId').checked = true;")
