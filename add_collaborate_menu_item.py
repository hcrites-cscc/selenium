    ...
    with open("add_collaborate_menu_item.txt', 'r', encoding='utf8') as course_file:
        ...
        for course_id in course_lines:
            ...
            try:
                ...
                editmode_status = driver.find_element(By.ID, "statusText").text

                if editmode_status.find("OFF") != -1:
                    driver.find_element(By.ID, "editModeToggleLink").click()
                ...
                # Click Tool Link
                driver.find_element(By.ID, "addToolLinkButton").click()

                # Enter Name
                driver.find_element(By.ID, "addToolLinkName").send_keys("Collaborate")
                ...
                driver.find_element(By.XPATH, "//input[@id='tool_link_availability_ckbox']").click()
